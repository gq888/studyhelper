...
export default function CoursePage() {
  ...
  return (
    <div className="container-app pb-52">
      ...
      {/* 底部操作栏 */}
      <div className="fixed inset-x-0 bottom-[var(--bottom-nav-h)] md:bottom-0 z-20 border-t border-brand-100/70 bg-white/95 px-4 pb-3 pt-2 backdrop-blur md:bottom-auto md:top-auto md:relative md:mt-4 md:rounded-3xl md:border md:p-4 md:shadow-card md:pb-4">
