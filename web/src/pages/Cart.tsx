    ...
    <div className="container-app pb-56">
      ...
      {items.length === 0 ? (
        ...
        <>
          ...
          <div className="fixed inset-x-0 bottom-[var(--bottom-nav-h)] md:bottom-0 z-20 border-t border-brand-100/70 bg-white/95 px-4 pb-3 pt-3 backdrop-blur md:pb-[max(env(safe-area-inset-bottom),12px)]">
